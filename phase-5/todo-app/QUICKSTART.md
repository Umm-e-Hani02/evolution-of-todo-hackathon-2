# Phase-5 Helm Chart - Quick Reference
...
```
phase-5/todo-app/
├── Chart.yaml                          # Updated with Phase-5 metadata
...
```bash
cd /mnt/d/SPECKIT-PLUS/evolution-of-todo/phase-5/todo-app
./deploy.sh
```
