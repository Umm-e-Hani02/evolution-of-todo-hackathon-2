# Phase-5 Todo App - Minikube Deployment Guide

This guide will help you deploy the Phase-5 AI-powered Todo Application to Minikube using Helm.
...
- Docker images built: `phase5-backend:latest` and `phase5-frontend:latest`
...
```bash
# Rebuild images
cd /mnt/d/SPECKIT-PLUS/evolution-of-todo/phase-5
